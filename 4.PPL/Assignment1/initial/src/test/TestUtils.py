...
#fix bug: ModuleNotFoundError: No module named 'ZCodeParser'
#when run: python run.py test LexerSuite
if not './main/zcode/parser/main/zcode/parser' in sys.path:
    sys.path.append('./main/zcode/parser/main/zcode/parser')
#end fix bug
